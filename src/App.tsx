...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'hero.h1a': 'Control Directo.',
    'hero.h1b': 'Rentabilidad Blindada.',
    'hero.sub': 'Dueños del Origen: Cultivo propio e infraestructura industrial de procesado. Eliminamos intermediarios y riesgos operativos para maximizar tu margen los 365 días del año.',
    ...
    'f1.k': 'SOMOS EL ORIGEN', 'f1.h': 'SIN INTERMEDIARIOS. Del cultivo a la plataforma.',
    'f1.b': 'Controlamos toda la cadena porque somos agricultores. Al eliminar eslabones innecesarios, garantizamos una estabilidad de precio anual y una frescura que se traduce en días extra de vida útil.',
    'f2.k': 'ESTANDARIZACIÓN', 'f2.h': 'DEL ENVASE AL FUEGO. Sin mermas, sin tiempos muertos.',
    'f2.b': 'Elimina el coste oculto de la preparación. Entregamos producto seleccionado, lavado y con cortes estandarizados listos para uso inmediato.',
    'f3.k': 'RENTABILIDAD', 'f3.h': 'RENDIMIENTO 100%: Ni un gramo de desperdicio.',
    'f3.b': 'Lo que compras es lo que sirves. Al comprar producto procesado, desaparece la merma técnica del recorte. Esto permite fijar un escandallo exacto y constante.',
    'f4.k': 'DIFERENCIACIÓN', 'f4.h': 'SOMOS EL ESPECIALISTA en setas para el Chef.',
    'f4.b': 'Elevamos el valor percibido de tus platos. Somos tu puente directo con las mejores zonas de recolección mundial y cultivos exóticos.',
    'pc.fs.em': 'FOODSERVICE E INDUSTRIA:', 'pc.fs.rest': 'Cadena de Suministro Blindada.',
    'pc.fs.p': 'Infraestructura agrícola de alto volumen para dominar la Distribución, la Restauración Organizada y los Mercados Centrales.',
    ...
    'f5.k': 'PORTFOLIO GLOBAL',
    'f5.h': 'Diferenciación en Carta: El Hub Fungi para el Chef.',
    'f5.b': 'Variedades exclusivas y silvestres los 365 días del año. Boletus, Chantarela, Shimeji, Trompeta. Continuidad en variedades críticas para mantener tus platos estrella en carta toda la temporada.',
    ...
    'fs.hero.em': 'FOODSERVICE E INDUSTRIA:',
    'fs.hero.span': 'Cadena de Suministro Blindada.',
  ...
  en: {
    ...
    'hero.h1a': 'Direct Control.',
    'hero.h1b': 'Secured Profitability.',
    'hero.sub': 'Masters of Origin: Own cultivation and industrial processing infrastructure. We eliminate middlemen and operational risks to maximise your margin 365 days a year.',
    ...
    'f1.k': 'WE ARE THE SOURCE', 'f1.h': 'NO MIDDLEMEN. From cultivation to platform.',
    'f1.b': 'We control the entire chain because we are farmers. By eliminating unnecessary links, we guarantee annual price stability and freshness that translates into extra days of shelf life.',
    'f2.k': 'STANDARDISATION', 'f2.h': 'FROM PACKAGING TO FIRE. No waste, no downtime.',
    'f2.b': 'Eliminate the hidden cost of preparation. We deliver selected, washed product with standardised cuts ready for immediate use.',
    'f3.k': 'PROFITABILITY', 'f3.h': '100% YIELD: Not a single gram of waste.',
    'f3.b': 'What you buy is what you serve. By purchasing processed product, technical trimming waste disappears. This allows you to set an exact and constant recipe cost.',
    'f4.k': 'DIFFERENTIATION', 'f4.h': 'WE ARE THE SPECIALIST in mushrooms for the Chef.',
    'f4.b': 'We elevate the perceived value of your dishes. We are your direct bridge to the best wild harvesting areas and exotic cultivations worldwide.',
    'pc.fs.em': 'FOODSERVICE & INDUSTRY:', 'pc.fs.rest': 'Secured Supply Chain.',
    'pc.fs.p': 'High-volume agricultural infrastructure to dominate Distribution, Organised Catering and Central Markets.',
    ...
    'f5.k': 'GLOBAL PORTFOLIO',
    'f5.h': 'Menu Differentiation: The Fungi Hub for the Chef.',
    'f5.b': 'Exclusive and wild varieties 365 days a year. Porcini, Chanterelle, Shimeji, Trumpet. Continuity in critical varieties to keep your signature dishes on the menu all season.',
    ...
    'fs.segment.rest': 'Organised Catering',
    'fs.segment.mc': 'Central Markets',
    'fs.segment.ind': 'Industry',
    'fs.hero.em': 'FOODSERVICE & INDUSTRY:',
    'fs.hero.span': 'Secured Supply Chain.',
  ...
  nl: {
    ...
    'hero.h1a': 'Directe Controle.',
    'hero.h1b': 'Beveiligde Rentabiliteit.',
    'hero.sub': 'Meesters van de Oorsprong: Eigen teelt en industriële verwerkingsinfrastructuur. Wij elimineren tussenpersonen en operationele risico\'s om uw marge 365 dagen per jaar te maximaliseren.',
    ...
    'f1.k': 'WIJ ZIJN DE BRON', 'f1.h': 'GEEN TUSSENPERSONEN. Van teelt tot platform.',
    'f1.b': 'Wij beheersen de volledige keten omdat wij boeren zijn. Door onnodige schakels te elimineren, garanderen wij jaarlijkse prijsstabiliteit en versheid die zich vertaalt in extra dagen houdbaarheidsdatum.',
    'f2.k': 'STANDAARDISATIE', 'f2.h': 'VAN VERPAKKING NAAR VUUR. Geen verspilling, geen stilstand.',
    'f2.b': 'Elimineer de verborgen kostprijs van de voorbereiding. Wij leveren geselecteerd, gewassen product met gestandaardiseerde sneden klaar voor onmiddellijk gebruik.',
    'f3.k': 'RENTABILITEIT', 'f3.h': '100% RENDEMENT: Niet één gram verspilling.',
    'f3.b': 'Wat u koopt is wat u serveert. Door verwerkt product te kopen, verdwijnt het technische snijverlies. Dit stelt u in staat een exacte en constante receptkostprijs vast te stellen.',
    'f4.k': 'DIFFERENTIATIE', 'f4.h': 'WIJ ZIJN DE SPECIALIST in paddenstoelen voor de Chef.',
    'f4.b': 'Wij verhogen de gepercipieerde waarde van uw gerechten. Wij zijn uw directe brug naar de beste wilde plukgebieden en exotische teelten wereldwijd.',
    'pc.fs.em': 'FOODSERVICE & INDUSTRIE:', 'pc.fs.rest': 'Beveiligde Toeleveringsketen.',
    'pc.fs.p': 'Grootvolume landbouwinfrastructuur om Distributie, Georganiseerde Catering en Centrale Markten te domineren.',
    ...
    'f5.k': 'GLOBAAL PORTFOLIO',
    'f5.h': 'Menukaart Differentiatie: De Fungi Hub voor de Chef.',
    'f5.b': 'Exclusieve en wilde variëteiten 365 dagen per jaar. Eekhoorntjesbrood, Cantarel, Shimeji, Trompet. Continuïteit in kritieke variëteiten om uw topgerechten het hele seizoen op de kaart te houden.',
    ...
    'fs.segment.rest': 'Georganiseerde Catering',
    'fs.segment.mc': 'Centrale Markten',
    'fs.segment.ind': 'Industrie',
    'fs.hero.em': 'FOODSERVICE & INDUSTRIE:',
    'fs.hero.span': 'Beveiligde Toeleveringsketen.',
  ...
  fr: {
    ...
    'hero.h1a': 'Contrôle Direct.',
    'hero.h1b': 'Rentabilité Sécurisée.',
    'hero.sub': 'Maîtres de l\'Origine : Culture propre et infrastructure industrielle de transformation. Nous éliminons les intermédiaires et les risques opérationnels pour maximiser votre marge 365 jours par an.',
    ...
    'f1.k': 'NOUS SOMMES LA SOURCE', 'f1.h': 'SANS INTERMÉDIAIRES. De la culture à la plateforme.',
    'f1.b': 'Nous contrôlons toute la chaîne parce que nous sommes agriculteurs. En éliminant les maillons inutiles, nous garantissons une stabilité de prix annuelle et une fraîcheur qui se traduit en jours supplémentaires de durée de vie.',
    'f2.k': 'STANDARDISATION', 'f2.h': 'DE L\'EMBALLAGE AU FEU. Sans pertes, sans temps mort.',
    'f2.b': 'Éliminez le coût caché de la préparation. Nous livrons un produit sélectionné, lavé et avec des coupes standardisées prêt pour une utilisation immédiate.',
    'f3.k': 'RENTABILITÉ', 'f3.h': 'RENDEMENT 100% : Pas un seul gramme de gaspillage.',
    'f3.b': 'Ce que vous achetez est ce que vous servez. En achetant du produit transformé, la perte technique de découpe disparaît. Cela permet de fixer un coût de recette exact et constant.',
    'f4.k': 'DIFFÉRENCIATION', 'f4.h': 'NOUS SOMMES LE SPÉCIALISTE en champignons pour le Chef.',
    'f4.b': 'Nous élevons la valeur perçue de vos plats. Nous sommes votre pont direct vers les meilleures zones de cueillette sauvage et les cultures exotiques mondiales.',
    'pc.fs.em': 'FOODSERVICE & INDUSTRIE :', 'pc.fs.rest': 'Chaîne d\'Approvisionnement Sécurisée.',
    'pc.fs.p': 'Infrastructure agricole à haut volume pour dominer la Distribution, la Restauration Organisée et les Marchés Centraux.',
    ...
    'f5.k': 'PORTFOLIO MONDIAL',
    'f5.h': 'Différenciation de Carte : Le Hub Fungi pour le Chef.',
    'f5.b': 'Variétés exclusives et sauvages 365 jours par an. Cèpes, Chanterelles, Shimeji, Trompettes. Continuité dans les variétés critiques pour maintenir vos plats signatures à la carte toute la saison.',
    ...
    'fs.segment.ind': 'Industrie',
    'fs.hero.em': 'FOODSERVICE & INDUSTRIE :',
    'fs.hero.span': 'Chaîne d\'Approvisionnement Sécurisée.',
...
function App() {
  ...
  const retailCards = [
    {
      id: 'comm',
    img: '/landing_foodservice_cultivo.png',
      icon: '✓',
      kicker: t('r1.k'),
      title: t('r1.h'),
      body: t('r1.b'),
  ...
  const foodserviceCards = [
    ...
    {
      id: 'rtc',
    img: '/landing_foodservice_4gama.png',
      icon: '✓',
    kicker: t('f2.k'),
    title: t('f2.h'),
    body: t('f2.b'),
    ...
    {
      id: 'distrib',
    img: '/landing_foodservice_escandallos.png',
      icon: '✓',
    kicker: t('f3.k'),
    title: t('f3.h'),
    body: t('f3.b'),
    ...
    {
      id: 'silvestres',
    img: '/landing_foodservice_especialistas.png',
      icon: '✓',
    kicker: t('f4.k'),
    title: t('f4.h'),
    body: t('f4.b'),
        ...
        <div className="wrap">
          ...
          <div className="tab-panels-wrap">
            ...
            {activeTab === 'foodservice' && (
              <div className="tab-panel active">
                <div className="section-confirm foodservice-hero" style={{background:'linear-gradient(135deg,#E8EEF5 0%,#fff 60%)',borderColor:'#C8D8E8'}}>
                  <span className="sc-icon">🔗</span>
                  <h2>
