...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'r1.k': 'Proyecto DROPS · IV Gama', 'r1.h': 'Dinamita para tu lineal de frío',
    'r1.b': 'Bandejas refrigeradas con mezclas premium. Máximo margen, máximo impulso.',
    'r2.k': 'Commodities · Alta Rotación', 'r2.h': 'El motor de tu categoría',
    'r2.b': 'Suministro masivo blindado los 365 días. Sin depender de terceros.',
    'r3.k': 'Especialidades Laminadas', 'r3.h': 'Listo para la sartén',
    'r3.b': 'Producto limpio y cortado que aumenta el valor de la cesta.',
    'r4.k': 'IN/OUT · Silvestres', 'r4.h': 'Tráfico e impulso en fechas clave',
    'r4.b': 'Exóticos estacionales de alto margen para Navidad y Otoño.',
  ...
  en: {
    ...
    'r1.k': 'DROPS Project · Convenience', 'r1.h': 'Dynamite for your chilled aisle',
    'r1.b': 'Refrigerated premium blends. Maximum margin, maximum impulse.',
    'r2.k': 'Commodities · High Rotation', 'r2.h': 'The engine of your category',
    'r2.b': 'Massive supply locked in 365 days. No third-party dependency.',
    'r3.k': 'Sliced Specialities', 'r3.h': 'Ready for the pan',
    'r3.b': 'Clean, cut product that increases basket value.',
    'r4.k': 'IN/OUT · Wild', 'r4.h': 'Traffic and impulse at key dates',
    'r4.b': 'Premium-margin seasonal exotics for Christmas and Autumn.',
    ...
    'd_drops.h': 'Convenience Innovation: DROPS Project',
    'd_drops.w': 'Chilled convenience platform: 2 permanent SKUs + 6 bi-monthly launches creating purchase urgency and lifting basket value.',
    'd_drops.f': 'Retailers who want to differentiate their fresh-cut aisle and drive traffic with innovations consumers can\'t find elsewhere.',
    'd_drops.r': '<h4>Multiply average basket with the \'Ready to Cook\' revolution.</h4><p>Consumers don\'t want to clean or cut; they want to open and cook. DROPS transforms mushrooms into a high-margin Convenience product.</p><ul><li><strong>Cook in the Package:</strong> Straight to Airfryer, oven or microwave.</li><li><strong>Upselling:</strong> Premium gastronomic solution with higher margin.</li><li><strong>Visual Impact:</strong> Force impulse purchase.</li></ul>',
    'd_comm.h': 'Secured Volume: High-Rotation Commodities',
    'd_comm.w': 'White button and Portobello mushrooms in 250g, 500g trays and bulk. Own production in La Rioja and Lleida + direct import.',
    'd_comm.f': 'Any retailer needing uninterrupted supply guarantee all year round, with stable pricing and integrated logistics.',
    'd_comm.r': '<h4>The engine of your fresh section. Zero stockouts, maximum volume.</h4><p>We know button mushrooms and Portobello aren\'t optional—they\'re mandatory on your shelf. An empty shelf means money to the competition. We guarantee the production muscle to absorb your demand peaks.</p><ul><li><strong>99% Fill Rate:</strong> Industrial supply guaranteed.</li><li><strong>Direct Freshness:</strong> No middlemen, longer shelf life in-store.</li><li><strong>Complete Range:</strong> White button, Portobello, Shiitake and Oyster calibrated mushrooms.</li></ul>',
    'd_espec.h': 'Customer Efficiency: Sliced Specialities',
    'd_espec.w': 'Clean, cut and calibrated mushrooms. 3mm sliced, stir-fry strips, coarse diced and calibrated whole. 100% yield.',
    'd_espec.f': 'Retailers wanting to lift category average price responding to today\'s consumer demand for convenience.',
    'd_espec.r': '<h4>Variety and efficiency straight to the pan.</h4><p>Our strength is sliced mushroom mixes. We deliver consumers restaurant-grade variety, cut to millimetre precision in a single format.</p><ul><li><strong>Strategic Mix:</strong> Multiple species in one SKU.</li><li><strong>Perfect Cut:</strong> Conveys cleanliness and professionalism.</li><li><strong>Protective Atmosphere (MAP):</strong> Extends shelf life and reduces shrinkage.</li></ul>',
    ...
    'd_vmi.h': 'VMI Logistics: Zero Shrinkage Guaranteed',
    'd_vmi.w': 'Vendor Managed Inventory: FME connected to your sales and stock data in real-time, autonomous replenishment, shrinkage absorbed by us.',
    'd_vmi.f': 'Retailers with integrable stock data (EDI, API, WMS). Requires minimum monthly volume.',
    'd_vmi.r': '<h4>VMI Integration: We manage stock, you count profits.</h4><p>We integrate with your systems (Vendor Managed Inventory) to read your checkout data and anticipate your needs. We send you exactly what you\'re going to sell.</p><ul><li><strong>Zero Shrinkage:</strong> We adjust production in real-time.</li><li><strong>Efficiency:</strong> Reduction in purchasing man-hours.</li><li><strong>Just-in-Time:</strong> Unbreakable cold chain.</li></ul>',
  ...
  nl: {
    ...
    'r1.k': 'DROPS Project · Convenience', 'r1.h': 'Dynamiet voor uw koelversschap',
    'r1.b': 'Gekoelde premium mengsels. Maximale marge, maximaal impuls.',
    'r2.k': 'Commodities · Hoge Rotatie', 'r2.h': 'De motor van uw categorie',
    'r2.b': 'Massaal volume geborgd 365 dagen. Geen derdenafhankelijkheid.',
    'r3.k': 'Gesneden Specialiteiten', 'r3.h': 'Klaar voor de pan',
    'r3.b': 'Schoon, gesneden product dat de bonwaarde verhoogt.',
    'r4.k': 'IN/OUT · Wildpluk', 'r4.h': 'Traffic en impuls op sleuteldagen',
    'r4.b': 'Premium-marge seizoensexotisch voor Kerst en Herfst.',
    ...
    'd_drops.h': 'Convenience Innovatie: DROPS Project',
    'd_drops.w': 'Gekoeld convenience platform: 2 permanente SKU\'s + 6 tweemaandelijkse lanceringen die koopurgentie creëren en bonwaarde verhogen.',
    'd_drops.f': 'Retailers die hun verse schap willen differentiëren en verkeer genereren met innovaties die consumenten nergens anders vinden.',
    'd_drops.r': '<h4>Vermenigvuldig gemiddelde bonwaarde met de \'Ready to Cook\' revolutie.</h4><p>De consument wil niet schoonmaken of snijden; hij wil openen en koken. DROPS transformeert paddenstoelen in een Convenience product met hoge marge.</p><ul><li><strong>Koken in de Verpakking:</strong> Direct naar Airfryer, oven of magnetron.</li><li><strong>Upselling:</strong> Premium gastronomische oplossing met hogere marge.</li><li><strong>Visuele Impact:</strong> Dwingt impulsaankoop.</li></ul>',
    'd_comm.h': 'Geborgd Volume: Hoogrotatie Commodities',
    'd_comm.w': 'Witte champignons en Portobello in 250g, 500g bakjes en bulk. Eigen productie in La Rioja en Lleida + directe import.',
    'd_comm.f': 'Elke retailer die ononderbroken leveringsgarantie nodig heeft het hele jaar, met stabiele prijzen en geïntegreerde logistiek.',
    'd_comm.r': '<h4>De motor van uw versafdeling. Nul voorraadbreuken, maximaal volume.</h4><p>We weten dat champignons en Portobello geen optie zijn—ze zijn verplicht in uw schap. Een leeg schap betekent geld naar de concurrent. Wij garanderen de productiekracht om uw vraagpieken op te vangen.</p><ul><li><strong>99% Fill Rate:</strong> Industriële levering gegarandeerd.</li><li><strong>Directe Versheid:</strong> Geen tussenpersonen, langere houdbaarheid in winkel.</li><li><strong>Compleet Gamma:</strong> Witte champignons, Portobello, Shiitake en Oesterzwammen gekalibreerd.</li></ul>',
    'd_espec.h': 'Klant Efficiëntie: Gesneden Specialiteiten',
    'd_espec.w': 'Schone, gesneden en gekalibreerde paddenstoelen. 3mm gesneden, roerbak strips, grof gehakt en gekalibreerd heel. 100% rendement.',
    'd_espec.f': 'Retailers die de gemiddelde categorieprijs willen verhogen door in te spelen op de hedendaagse consumentenvraag naar gemak.',
    'd_espec.r': '<h4>Variëteit en efficiëntie direct naar de pan.</h4><p>Onze kracht is het gesneden paddenstoelmengsel. We leveren consumenten restaurant-kwaliteit variëteit, gesneden op de millimeter in één formaat.</p><ul><li><strong>Strategische Mix:</strong> Meerdere soorten in één SKU.</li><li><strong>Perfecte Snede:</strong> Straalt netheid en professionaliteit uit.</li><li><strong>Beschermende Atmosfeer (MAP):</strong> Verlengt houdbaarheid en vermindert krimp.</li></ul>',
    ...
    'd_vmi.h': 'VMI Logistiek: Nul Krimp Gegarandeerd',
    'd_vmi.w': 'Vendor Managed Inventory: FME gekoppeld aan uw verkoop- en voorraaddata in real-time, autonome aanvulling, krimp geabsorbeerd door ons.',
    'd_vmi.f': 'Retailers met integreerbare voorraaddata (EDI, API, WMS). Vereist minimaal maandvolume.',
    'd_vmi.r': '<h4>VMI Integratie: Wij managen voorraad, u telt de winst.</h4><p>Wij integreren met uw systemen (Vendor Managed Inventory) om uw kassadata te lezen en uw behoeften te anticiperen. Wij sturen u exact wat u gaat verkopen.</p><ul><li><strong>Nul Krimp:</strong> We passen productie aan in real-time.</li><li><strong>Efficiëntie:</strong> Reductie van inkoopuren.</li><li><strong>Just-in-Time:</strong> Ononderbroken koelketen.</li></ul>',
  ...
  fr: {
    ...
    'r1.k': 'Projet DROPS · IV Gama', 'r1.h': 'Dynamite pour votre rayon frais',
    'r1.b': 'Mélanges premium réfrigérés. Marge maximum, impulsion maximum.',
    'r2.k': 'Commodités · Haute Rotation', 'r2.h': 'Le moteur de votre catégorie',
    'r2.b': 'Approvisionnement massif garanti 365 jours. Sans dépendance aux tiers.',
    'r3.k': 'Spécialités Émincées', 'r3.h': 'Prêt pour la poêle',
    'r3.b': 'Produit propre et découpé qui augmente la valeur du panier.',
    'r4.k': 'IN/OUT · Sauvages', 'r4.h': 'Trafic et impulsion aux dates clés',
    'r4.b': "Exotiques saisonniers à haute marge pour Noël et l'Automne.",
    ...
    'd_drops.h': 'Innovation IV Gamme: Projet DROPS',
    'd_drops.w': 'Plateforme de convenance réfrigérée: 2 références permanentes + 6 lancements bimestriels créant urgence d\'achat et augmentant le panier.',
    'd_drops.f': 'Retailers souhaitant différencier leur rayon frais et générer du trafic avec des nouveautés introuvables ailleurs.',
    'd_drops.r': '<h4>Multipliez le panier moyen avec la révolution \'Ready to Cook\'.</h4><p>Le consommateur ne veut pas nettoyer ni couper ; il veut ouvrir et cuisiner. DROPS transforme le champignon en produit Convenience à forte marge.</p><ul><li><strong>Cuisine dans l\'Emballage:</strong> Directement à l\'Airfryer, au four ou au micro-ondes.</li><li><strong>Upselling:</strong> Solution gastronomique premium avec marge supérieure.</li><li><strong>Impact Visuel:</strong> Forcent l\'achat d\'impulsion.</li></ul>',
    'd_comm.h': 'Volume Sécurisé: Commodités Haute Rotation',
    'd_comm.w': 'Champignon blanc et Portobello en barquettes 250g, 500g et vrac. Production propre à La Rioja et Lleida + importation directe.',
    'd_comm.f': 'Tout retailer nécessitant garantie d\'approvisionnement ininterrompu toute l\'année, avec prix stable et logistique intégrée.',
    'd_comm.r': '<h4>Le moteur de votre rayon frais. Zéro rupture, volume maximum.</h4><p>Nous savons que le champignon blanc et le Portobello ne sont pas une option, ils sont une obligation dans votre linéaire. Un rayon vide c\'est de l\'argent pour la concurrence. Nous vous garantissons le muscle productif pour absorber vos pics de demande.</p><ul><li><strong>Taux de Service de 99%:</strong> Approvisionnement industriel garanti.</li><li><strong>Fraîcheur Directe:</strong> Sans intermédiaires, plus de durée de vie en magasin.</li><li><strong>Gamme Complète:</strong> Champignon blanc, Portobello, Shiitake et Pleurotes calibrés.</li></ul>',
    'd_espec.h': 'Efficacité Client: Spécialités Émincées',
    'd_espec.w': 'Champignons propres, découpés et calibrés. Émincé 3mm, lanières sautées, dés coarse et entiers calibrés. 100% rendement.',
    'd_espec.f': 'Retailers voulant augmenter le prix moyen de leur catégorie en répondant à la demande de convenance du consommateur actuel.',
    'd_espec.r': '<h4>Variété et efficacité directe à la poêle.</h4><p>Notre force c\'est le mélange de champignons émincés. Nous livrons au consommateur la variété des restaurants, coupée au millimètre dans un format unique.</p><ul><li><strong>Mix Stratégique:</strong> Plusieurs espèces en un seul SKU.</li><li><strong>Coupe Parfaite:</strong> Transmet propreté et professionnalisme.</li><li><strong>Atmosphère Protectrice (MAP):</strong> Prolonge la durée de vie et réduit la casse.</li></ul>',
    ...
    'd_vmi.h': 'Logistique VMI: Zéro Casse Garantie',
    'd_vmi.w': 'Vendor Managed Inventory: FME connecté à vos données de vente et stock en temps réel, réapprovisionnement autonome, casse absorbée par nous.',
    'd_vmi.f': 'Retailers avec données de stock intégrables (EDI, API, WMS). Nécessite volume mensuel minimum.',
    'd_vmi.r': '<h4>Intégration VMI: Nous gérons le stock, vous comptez les bénéfices.</h4><p>Nous nous intégrons avec vos systèmes (Vendor Managed Inventory) pour lire vos sorties de caisse et anticiper vos besoins. Nous vous envoyons exactement ce que vous allez vendre.</p><ul><li><strong>Casse Zéro:</strong> Nous ajustons la production en temps réel.</li><li><strong>Efficacité:</strong> Réduction des heures-homme en achats.</li><li><strong>Just-in-Time:</strong> Chaîne du froid ininterrompue.</li></ul>',
...
function RetailDrawer({ drawerId, isOpen, onClose, t, showFormat, onPrev, onNext, canPrev, canNext, onOpenCatalog, catalogButtonLabel }: DrawerProps) {
  ...
  const retailLabels: Record<string, { what: string; for: string; result: string }> = {
    comm: {
      what: 'Sin intermediarios. Sin excusas.',
      for: 'CADA HORA CUENTA. EL TIEMPO ES FRESCURA.',
      result: 'CONSTANCIA ABSOLUTA. CALIDAD SIN SORPRESAS.',
    },
    espec: {
      what: 'Liderazgo en Cultivo Asiático: Importación Directa',
      for: 'Cadena de Suministro Global: Setas Silvestres sin fronteras',
      result: 'Especialistas en lo Imposible: El catálogo Fungi definitivo',
    },
    drops: {
      what: 'Calidad Estandarizada: El fin de la variabilidad.',
      for: 'Conveniencia Real: De la balda a la mesa en 6\'.',
      result: 'Categoría Viva: Calendario de Drops y Promociones.',
    },
    vmi: {
      what: 'Tu stock, bajo nuestro radar.',
      for: 'Los Pilares Operativos',
      result: 'Sincronización y KPI.',
    },
  };
...
function App() {
  ...
  const retailCards = [
    {
      ...
      icon: '✓',
      kicker: 'CULTIVO. EL ORIGEN',
      title: 'SOMOS CULTIVADORES. Garantia de suministro directo',
      body: 'Volumen 365 dias · Frescura <24h · Certificacion IFS. Controlamos el 100% de la cadena, del sustrato al lineal.',
    },
    {
      id: 'espec',
      img: '/landing_retail_especializacion.png',
      icon: '✓',
      kicker: 'ESPECIALIZACION',
      title: 'ESPECIALIZACIÓN: Todo el Reino Fungi en un solo proveedor.',
      body: 'Del cultivo masivo a la recolección silvestre. Dominamos cada variedad para que tú no tengas que buscar fuera. Portfolio integral, conocimiento técnico y eficiencia logística en un único partner.',
    },
    {
      id: 'drops',
      img: '/retail_diferenciacion2.png',
      icon: '✓',
      kicker: 'DIFERENCIACION.',
      title: 'INNOVACIÓN: Dinamizamos tu Lineal y creamos ocasiones de consumo.',
      body: "Creamos ocasiones de consumo que elevan tu ticket medio: mixes laminados estandarizados, soluciones Ready-to-Cook y estrategia DROPS con calendario IN-OUT para maximizar margen.",
    },
    {
      id: 'vmi',
      img: '/landing_vmi.png',
      icon: '✓',
      kicker: 'SERVICIO VMI',
      title: 'PARA CLIENTES PREMIUM. Gestión activa del stock para reducir la merma a 0.',
      body: 'Logística de precisión y gestión inteligente para un lineal siempre perfecto. VMI & Reposición, logística inversa y merma cero para eliminar roturas de stock y optimizar la operativa.',
    },
  ];
  ...
  const techCatalogs: Record<string, { title: string; button: string; photos: string[]; columns: string[]; rows: string[][] }> = {
    comm: {
      title: 'Catalogo Retail: Commodities',
      button: 'Nuestros productos base: formatos y gramajes',
      photos: ['/n2_retail_commodities.png', '/n2_retail_commodities1.png'],
      columns: ['Producto', 'Tipo de envase', 'Formatos disponibles', 'Vida útil'],
      rows: [
    ...
    espec: {
      title: 'Catalogo Retail: Especializacion',
      button: 'Calendario de Disponibilidad',
    ...
    drops: {
      title: 'Catalogo Retail: Mixes y Drops',
      button: 'Inspiracion',
    ...
    vmi: {
      title: 'Catalogo Retail: Logistica VMI',
      button: 'VMI. Servicio PREMIUM.',
